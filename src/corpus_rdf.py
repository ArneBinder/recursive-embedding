...
def serialize_jsonld(jsonld, discard_predicates=(), sort_map={}):
    ...
    for r_key in refs:
        r_targets = refs[r_key]
        refs[r_key] = [ids.get(r, r) for r in r_targets]
...
def main2():
    ...
    ser, ids, refs = serialize_jsonld(dummy_jsonld,
