...
## EDGES
./train.sh "$USE_GPUS" RE/SEMEVAL2010T8/EDGES/LM_LCA_NEW train-settings/task/re-semeval.env train-settings/model/lm.env train-settings/dataset/corenlp/semeval-edges-FIXED.env "$ENV_GENERAL"
