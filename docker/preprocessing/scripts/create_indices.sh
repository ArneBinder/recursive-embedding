...
## TACRED   EXCLUDED
#python src/corpus_rdf.py CREATE_INDICES --merged-forest-path "$CORPORA_OUT"/TACRED_RDF/None_recemb_ner_mc20/forest --split-count "$SPLIT_COUNT" 2>&1
#python src/corpus_rdf.py CREATE_INDICES --merged-forest-path "$CORPORA_OUT"/TACRED_RDF/None_recemb_ner_edges_mc20/forest --split-count "$SPLIT_COUNT" 2>&1
#python src/corpus_rdf.py CREATE_INDICES --merged-forest-path "$CORPORA_OUT"/TACRED_RDF/None_recemb_ner_span_mc20/forest --split-count "$SPLIT_COUNT" 2>&1
