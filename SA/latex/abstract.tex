...
gained increasing attention. These models build upon Distributional Semantics, i.e. a word is defined by its context, and scale up to billions of training tokens % \autocite{mikolov_distributed_2013}
