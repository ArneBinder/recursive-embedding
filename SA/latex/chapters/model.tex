...
This chapter describes the architecture of the neural models used to calculate a similarity score for a given sentence tuple and how these models are trained.\todo{UL: Hier wäre mehr Übersicht gut: was komtm jetzt? Was wurde gemacht? Was davon ist neu? Was ist das Ziel? (X)} \todo{AB: introduce the two parameters!}
