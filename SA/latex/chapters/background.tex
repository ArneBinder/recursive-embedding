...
\acp{VSM} \autocite{turney_frequency_2010} build upon occurrences of terms $T$ in certain contexts $C$. For instance, a word can occur as term in a document, i.e. its context, or not. We define $T = \{t_1, ..., t_m\}$ as finite set of opaque symbols with $m = |T|$ and the set of contexts $C \subseteq T^*$ 
% = \{c_1, ..., c_n: c_i = (t \in T)\}$ 
