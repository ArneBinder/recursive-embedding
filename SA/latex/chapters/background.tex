...
State of the art systems achieve labeled attachment scores (LAS) of 90.7\% and labeling scores (LS) of 94.7\% \autocite[][see]{choi_it_2015} at the English OntoNotes corpus \autocite{weischedel_ontonotes_2011}. The authors of the corpus name an inter-annotator agreement of 98.5\% F1 for syntactical annotations on a sampled subset.
