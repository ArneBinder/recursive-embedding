...
#vocab_manual = {WORD_EMBEDDING: u'WORD', EDGE_EMBEDDING: u'DEPENDENCY', UNKNOWN_EMBEDDING: u'UNKNOWN',
#                TERMINATOR_EMBEDDING: u'TERMINATOR', ENTITY_TYPE_EMBEDDING: u'ENTITY',
#                LEMMA_EMBEDDING: u'LEMMA', POS_TAG_EMBEDDING: u'POS'}
